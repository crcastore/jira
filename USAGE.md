...
- In the Jira create form, choose a GitHub repository, then choose an available `PR / MR` to include the PR and changed files in the Jira description. Add names as separate rows in `Subtask names` to create one child `Sub-task` per name.
